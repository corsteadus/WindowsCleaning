...
export const usersTable = pgTable("users", {
  ...
  // Local username/password login (optional — most users sign in via Replit Auth).
  // Only users provisioned with a username + passwordHash can use POST /api/auth/login.
