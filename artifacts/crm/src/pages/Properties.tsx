      ...
      {canManage && <Dialog open={showEditor} onOpenChange={setShowEditor}>
        <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto rounded-2xl">
          ...
          <form onSubmit={save} className="space-y-4">
            ...
            {/* Screens / Hard water / Tracks removed (Profile Notes #12). */}
            <div className="flex flex-wrap gap-4 text-sm text-slate-600"><label className="flex items-center gap-2"><input type="checkbox" checked={draft.isBillingAddress} onChange={(e) => setField("isBillingAddress", e.target.checked)} className="accent-primary" />Billing address</label></div>
